...
namespace QuickConnect.KeePass.UI
{
    public sealed class HotKeyControlEx : TextBox
    {
        private const string KeyboardKeyCtrlLeft = "LCtrl";
        private const string KeyboardKeyShiftLeft = "LShift";
        private const string KeyboardKeyInvalid = "Invalid Key";
        ...
        private readonly ContextMenu m_ctxNone = new ContextMenu();
        ...
        public void RenderHotKey()
        {
                ...
                m_vNeedNonShiftModifier.Contains(m_kHotKey))
            {
                ...
                {
                    m_kHotKey = Keys.None;
                    this.Text = ModifiersToString(m_kModifiers) + " + " + KeyboardKeyInvalid;
        ...
        private string ModifiersToString(Keys kModifiers)
        {
            ...
            if ((kModifiers & Keys.Shift) != Keys.None)
                str = (m_bNoRightModKeys ? KeyboardKeyShiftLeft : KPRes.KeyboardKeyShift);
            if ((kModifiers & Keys.Control) != Keys.None)
            {
                if (str.Length > 0) str += ", ";
                str += (m_bNoRightModKeys ? KeyboardKeyCtrlLeft : KPRes.KeyboardKeyCtrl);
            }
            ...
            bool bNoRightModKeys)
        {
            ...
            HotKeyControlEx hk = new HotKeyControlEx
            {
                ...
                Size = tb.Size,
                NoRightModKeys = bNoRightModKeys
            };
